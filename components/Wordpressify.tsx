...
const Wordpressify = (props: Props) => {
  return (
    ...
    <div className="w-full h-[35vh]  p-8 mx-auto max-w-5xl   flex flex-row items-center ">
        ...
        <div className="w-full h-full bg-white rounded-sm shadow-md flex flex-col justify-center text-center items-center">
            <h5 className='text-[#010]'>View my portfolio made with <strong>Wordpress</strong></h5>
