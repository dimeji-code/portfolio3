...
const Header = () => {
  ...
  return (
    <header className={headerDown ==false?
        ...
        'sticky top-0 flex h-[70px] z-100 justify-between mx-auto max-w-5xl rounded-b-md linear ease-in duration-1000 z-50 p-5 w-[100vw] xl:items-center bg-[#3a220f98]'}>
