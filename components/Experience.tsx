...
const Experience = (props: Props) => {
  ...
  const ukemeyJob = {company:"Ukemey Inc.", role:"Fullstack developer", loc:"Remote",dur:"Sept 2021 - Mar 2022", desc:"Developed mobile and web based applications for clients of the company. Use of automation tools for webscraping data."}
