...
const Experience = (props: Props) => {
  ...
  const ukemeyJob = {company:"Ukemey Inc.", role:"Jr. Fullstack developer", loc:"Remote",dur:"August 2021 - March 2022", desc:"Developed mobile and web based applications for clients of the company. Use of automation tools for webscraping data."}
