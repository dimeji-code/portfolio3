...
const Experience = (props: Props) => {
  const ukemeyTools:string[] = ['Typescript','ReactJS','React Native','MongoDB','AWS','Google Tag Manager']
  const freelanceTools:string[] = ['JavaScript','React','React Native',"HTML"]
  const ukemeyJob = {company:"Ukemey Inc.", role:"Fullstack developer", loc:"Ottawa (Remote)",dur:"Sept 2021 - Mar 2022", desc:"Developed mobile and web based applications for clients of the company. Use of automation tools for webscraping data."}
    const freelance = {company:"Decor & Vibes", role:"Full stack developer & Consultant", loc:"Ottawa (Remote)",dur:"Nov 2022 - Sept 2024", desc:"Using React and React native to turn wireframe designs into functional and fully responsive web applications for clients."}
return(
